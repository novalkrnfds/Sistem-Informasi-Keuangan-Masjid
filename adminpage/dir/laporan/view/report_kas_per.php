...
<body onLoad="window.print()">
	<center>
		...
		<center>
			...
			<p style="font-size: 16px">Periode : <?php echo date('d-m-Y', strtotime($tgl_start)); ?> Sampai : <?php echo date('d-m-Y', strtotime($tgl_end)); ?></p>
		...
		<table border="1" cellspacing="0" cellpadding="0">
			...
			<?php
				...
				<tr>
					<td colspan="3" style="padding:20px;" align="right"><strong>TOTAL SALDO SAMPAI TANGGAL <?php echo date('d-m-Y', strtotime($tgl_end)); ?> </strong></td>
					<td colspan="2" align="center"><strong>Rp. <?php $total = ($hitungPem['hitungSaldo'] - $hitungPen['hitungPengeluaran']); echo number_format($total,0,',','.').".00,-";?></strong></td>
				</tr>
			</tbody>
		</table>
		<br><br>
